...
const DepartureAddress: FC<Props> = function ({ setBottomSheetState }) {
    ...
    const [snapPos, setSnapPos] = useState(
        BOTTOM_SHEET_SNAP_POINTS[BottomSheetStateEnum.SET_DEPARTURE_ADDRESS][0]
    );
    useEffect(() => {
        const points =
            BOTTOM_SHEET_SNAP_POINTS[
                BottomSheetStateEnum.SET_DEPARTURE_ADDRESS
            ];
    ...
    function handleSelectAddress(selectedAddress: string) {
        handleSetEditingOrder({
            ...editingOrder,
            departure: { ...editingOrder.departure, address: selectedAddress },
        });
        setBottomSheetState(BottomSheetStateEnum.SET_DEPARTURE_LOCATION);
    }
    ...
    function handleSearchAddress() {
        ...
        const searchQuery = editingOrder.departure.city
            ? `${editingOrder.departure.city},${search}`
            : search;
