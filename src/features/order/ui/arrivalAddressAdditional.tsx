...
import { getAddress, getCities } from "../model/order-actions";
...
const ArrivalAddressAdditonal: FC<Props> = function({setBottomSheetState}) {
    ...
    const [snapPos, setSnapPos] = useState(BOTTOM_SHEET_SNAP_POINTS[BottomSheetStateEnum.SET_ARRIVAL_ADDRESS_ADDITIONAL][0]);
    useEffect(() => {
        const points = BOTTOM_SHEET_SNAP_POINTS[BottomSheetStateEnum.SET_ARRIVAL_ADDRESS_ADDITIONAL];
    ...
    function handleSelectAddress(selectedAddress: string) {
        ...
        arrival.address = selectedAddress;
...
export default ArrivalAddressAdditonal;