...
type GpsEnableModalProps = {
    setFindTaxiState: () => void;
}

export const GpsEnableModal: FC<GpsEnableModalProps> = ({ setFindTaxiState }) => {
    ...
    return(
        <BottomSheet
            ref={sheetModalRef}
            index={0}
            backgroundStyle={styles.bototmSheetBackground}
            snapPoints={Platform.OS === "ios" ? [440] : [410]}
            ...
            enableHandlePanningGesture={false}>
                <View style={styles.container}>
                    ...
                    <View style={styles.buttons_holder}>
                        ...
                        <Button onPress={setFindTaxiState} projectType="secondary">
